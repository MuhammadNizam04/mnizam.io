...
<body>
    ...
    <div class="cool-box">
            ...
            <div class="overlay">
                ...
                <div class="button-container">
                    ...
                    <a href="create.php" class="button">Pesan</a>
                </div>
            </div>
     </div>
        ...
        <div class="cool-box">
            ...
            <div class="overlay">
                <h2>Buah-Buahan</h2>
                <p>Warna-warni buah-buahan untuk memberikan sentuhan keceriaan.</p>
                <div class="button-container">
                    <a href="#" class="button">Detail</a>
                    <a href="create.php" class="button">Pesan</a>
                </div>
        ...
        <div class="cool-box">
            ...
            <div class="overlay">
                <h2>Daging</h2>
                <p>Kelezatan daging dalam tampilan yang menggoda.</p>
                <div class="button-container">
                    <a href="#" class="button">Detail</a>
                    <a href="create.php" class="button">Pesan</a>
                </div>
    ...
    <footer class="footer">
        <div class="footer-content">
            ...
            <form id="form-pesan" action="user.php" method="post">
            <label for="pesan-nama">Nama:</label>
            <input type="text" id="pesan-nama" name="pesan-nama" required>

            <label for="pesan-email">Email:</label>
            <input type="email" id="pesan-email" name="pesan-email" required>

            <label for="pesan-pesan">Pesan:</label>
            <textarea id="pesan-pesan" name="pesan-pesan" rows="4" required></textarea>
...
function submitForm() {
        ...
        var email = document.getElementById("pesan-email").value;
        var pesan = document.getElementById("pesan-pesan").value;

        
        if (nama.trim() === "" || email.trim() === "" || pesan.trim() === "") {
            alert("Silakan isi semua kolom label sebelum mengirim pesan.");
        } else {
